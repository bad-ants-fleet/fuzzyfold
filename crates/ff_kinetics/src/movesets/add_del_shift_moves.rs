...
impl<'a, E: EnergyModel> AddDelShiftMoves<'a, E> {
    ...
    fn get_shift_neighbors_per_loop(&self, index: usize, ll: &[usize]) -> Vec<(Move, i32)> {
        let ltab = &self.loop_table;
...
//
//        let adm1 = AddDelShiftMoves::from(ltab1);
//        let mut adm2 = AddDelShiftMoves::from(ltab2);
//
